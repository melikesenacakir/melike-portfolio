...
export const Skills = () => {
    return (
    <div className="relative bg-gradient-to-t from-lightBlue to-darkBlue h-screen flex flex-col overflow-hidden">
        <div 
        ...
        <div className="relative z-10 flex flex-col h-full">
            <Navbar />
            <div className="flex flex-1 items-center grid grid-cols-2 sm:grid-cols-6 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-4 gap-6 mx-auto">
